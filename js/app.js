 ...
 */
    ...
    (() => {
            ...
            constructor(props, data = null) {
                ...
                if (this.config.init) {
                    ...
                    if (selectItems.length) {
                        ...
                        this.setLogging(`селектов: (${selectItems.length})`);
        ...
        function calc() {
            var ps1 = .01 / (100 * 12);
            var ps2 = 40 / (100 * 12);
            var sk = $(".form-calculator__input").val();
            if (!sk) sk = 2e4;
            var m = $(".form-calculator__select").val();
            var ap1 = sk * ps1 / (1 - Math.pow(1 + ps1, -m));
            var ap2 = sk * ps2 / (1 - Math.pow(1 + ps2, -m));
            $("p.actions-calculator__sum span").text(Math.round(ap1));
            $("p.actions-calculator__sum-after span").text(Math.round(ap2));
        }
        $(".opt").change((function() {
            calc();
        }));
        $(document).on("input", ".form-calculator__input", (function() {
            var value = $(this).val();
            var rep = /\D/;
            if (rep.test(value)) {
